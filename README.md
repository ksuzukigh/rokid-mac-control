...
2. 「“Rokid Control.app” は開いていません」と表示されたら「完了」を押します。
3. Macの「システム設定」→「プライバシーとセキュリティ」を開き、一番下までスクロールします。`Rokid Control`の「このまま開く」を押します。
4. Finderの「アプリケーション」フォルダに戻り、`Rokid Control`をもう一度開きます。
...
2. MacにRokidと同じ画面が表示されるまで待ちます。接続には最大1分ほどかかることがあります。

Rokidと同じ画面がMacのウインドウに表示されたら接続完了です。以降はUSBケーブルを外して、Wi-Fiで接続できます。
